...
namespace ScratchPad
{
    public static class Program
    {
        public static int Main()
        {
			...
			var process = new BufferedObservableProcess(new ObservableProcessArguments("ipconfig", "/all")
			{
			});
			...
			Console.WriteLine($"- ExitCode:{process.LastExitCode} Press Any Key to Quit ---");
			Console.ReadKey();
            return 0;
        }
    }
