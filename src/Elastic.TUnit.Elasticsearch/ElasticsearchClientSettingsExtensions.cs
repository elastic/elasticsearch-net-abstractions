...
public static class ElasticsearchClientSettingsExtensions
{
	...
	///     <c>TUnitTestOutputWriter</c> from <c>Elastic.TUnit</c> so that
	///     request/response logs appear in the current test's output.
	/// </summary>
	public static ElasticsearchClientSettings WireTUnitOutput(
