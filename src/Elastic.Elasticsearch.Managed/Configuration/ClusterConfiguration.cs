...
namespace Elastic.Elasticsearch.Managed.Configuration
{
	...
	public class ClusterConfiguration : ClusterConfiguration<NodeFileSystem>
	{
		...
		public ClusterConfiguration(ElasticVersion version,
			Func<ElasticVersion, string, NodeFileSystem> fileSystem = null, int numberOfNodes = 1,
		...
		where TFileSystem : INodeFileSystem
	{
		...
		///     Passed the Elasticsearch version and the Cluster name
		/// </param>
		/// <param name="numberOfNodes">The number of nodes in the cluster</param>
		/// <param name="clusterName">The name of the cluster</param>
		public ClusterConfiguration(ElasticVersion version, Func<ElasticVersion, string, TFileSystem> fileSystem,
		...
		public virtual string CreateNodeName(int? node) =>
			node.HasValue ? $"managed-elasticsearch-{node}" : " managed-elasticsearch";
